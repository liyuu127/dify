...
const CreateAppCard = (
  ...
  return (
    <div className='bg-background-default-dimm flex min-h-[160px] flex-col rounded-xl border-[0.5px] border-components-panel-border
      shadow-1xl transition-all duration-200 ease-in-out'
    >
      ...
      <div ref={ref} onClick={modalShowHandle} className='group flex grow cursor-pointer items-start p-4'>
        <div className='flex items-center gap-3'>
          <div className='flex h-10 w-10 items-center justify-center rounded-lg border border-dashed border-divider-regular bg-background-default-lighter
            p-2 group-hover:border-solid group-hover:border-effects-highlight group-hover:bg-background-default-dodge'
          >
            <RiAddLine className='text-AI-text-tertiary h-4 w-4 group-hover:text-text-accent'/>
          </div>
          <div className='system-md-semibold text-AI-text-secondary group-hover:text-text-accent'>{t('dataset.createDataset')}</div>
        </div>
      </div>
